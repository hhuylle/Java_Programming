...
public class MapPractice4 {
    ...
    public static void main(String[] args) {
        ...
        Map<Map<String, Integer>, Map<String, Integer>> mapOfMaps2 = new LinkedHashMap<>();// avoid to use this map of map, because it consumes more memories
