...
public class WarmupCydeoLogIn {
    ...
    public static void main(String[] args) {
        ...
        if (u.equals("Cydeo") && p.equals("WoodenSpoon")){ // if credentials are valid/correct
            ...
            for (int i = 0; i < 3; i++) { // i: 0, 1, 2
                ...
                if (u.equals("Cydeo") && p.equals("WoodenSpoon")){ // if the user enters valid credentials
                    ...
                    break; // exits the loop if the credentials are correct
                }
            }

            if (!(u.equals("Cydeo") && p.equals("WoodenSpoon"))){ // after all three attempts, if the credentials are still incorrect
