...
public class WarmupTask1Employees {
    /*
    Warmup tasks:
    ...
    public static void main(String[] args) {
        ...
        for (Employee each : employees) {
            if (each.jobTitle.equals("Java Developer")){ // if the job title of the employee is Java Developer
                System.out.println(each.name); // print names of the employee
            }
        }
        ...
        for (Employee employee : employees) {
            if (employee.gender == 'M'){ // if the employees are male
        ...
        System.out.println("Totel number of female employees: "+femaleEmployees.size());
