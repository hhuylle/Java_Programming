...
public class Holidays {
    ...
    public static void main(String[] args) {
        ...
        for (LocalDate eachDate : getHolidays()) { // iterates through all the LocalDate object
            if (eachDate.getMonthValue() == month){
                System.out.println(eachDate.format(df));
               //System.out.println(eachDate.format(DateTimeFormatter.ofPattern("MM-dd-y")));
            }
