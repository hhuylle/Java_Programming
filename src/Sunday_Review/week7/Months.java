...
public class Months {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hello, enter the month numbers 1 ~ 12: ");
        int month = input.nextInt();
        input.close();

        if (month >=1 && month<=12){

            String[] data = {"January","February","Mar","April","May","June","July","August","September","October","November","December"};

            System.out.println(data[month-1]);
            // -1 allows the month to become an index, because indexes start from 0
            // the above line prints one element from the array, which was a String

        }else {
            System.err.println("Sorry, "+month+" is not a valid month number!");
        }
