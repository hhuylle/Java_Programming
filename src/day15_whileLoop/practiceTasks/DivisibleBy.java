...
public class DivisibleBy {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < number; i++) {
            if (i%15==0 && i%5==0 && i%3==0){ // if the number can be divisible by 15/5/3
                divisibleBy15 += i + " ";
            } else if ( i%5==0 && i%15!=0) { // if the number divisible by 5 but not be divisible by 15
                divisibleBy5 += i + " ";
            } else if ( i%3==0 && i%15!=0) { // if the number divisible by 3 but not be divisible by 15
                divisibleBy3 += i + " ";
            }
        }
